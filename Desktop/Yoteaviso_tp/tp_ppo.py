...
link_cliente = str(input("Hola "+ nombre +", dejanos el link de Mercadolibre del articulo que te gusta:",))
...
if precioInicial < precio_alerta:
    phone_no= whatsapp
    parsedMessage=("Hola " + nombre + ", soy Carla de Yo te aviso.Tu auto bajo de precio, el precio en dolares es USD"+ preciowappstr + " .No dudes mas, compralo YA!" + link_cliente)
